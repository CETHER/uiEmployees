...
export class Department extends Component {
  ...
  filterFn() {
    ...
    let filteredData = this.state.departmentsWithoutFilter.filter((el) => {
      return (
        el.id
          .toString()
          .toLowerCase()
  ...
  deleteClick(dep) {
    if (window.confirm("Are you sure to delete the department " + dep.name)) {
      fetch(variables.API_URL + "department/" + dep.id, {
        method: "DELETE",
        headers: {
          Accept: "application/json",
          "Content-Type": "application/json",
